...
{
    public static class LuaBattleHelper
    {
        public static async void ShowSelectPanel(List<int> teamMates, Action<List<int>> callback)
        {
            //必选人物
            ...
            selectPram.roleList = GameRuntimeData.Instance.GetTeam().ToList();
    ...
    public class LuaBattleLoader : MonoBehaviour
    {
